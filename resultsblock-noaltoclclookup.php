...
if ($field === "titlesearch")  {
    ...
    $sql = "SELECT " . $fields . " FROM bib_info
            INNER JOIN local_worldcat_oclc_nbr ON local_worldcat_oclc_nbr.worldcat_oclc_nbr = bib_info.worldcat_oclc_nbr
            WHERE bib_info.worldcat_oclc_nbr = ". $query
            . " or local_worldcat_oclc_nbr.local_oclc_nbr = " . $query ;
